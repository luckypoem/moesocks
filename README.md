...
* [shadowsocks] greatly inspired MoeSocks.
  ...
  this much redundancy of variety of encryption, each requires years of research
  to break in, the Great Firewall of China (GFW) is likely to be left with only
  two options: block any transmission it can not understand using any method,
  particularly DPI, or leave shadowsocks alone. So far GFW has chosen the
  latter. Can you see the genius design of shadowsocks now?
