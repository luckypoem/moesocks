...
* [shadowsocks] greatly inspired MoeSocks.
  ...
  swapped to another one, for example, Salsa20. With this much redundancy in
  encryption options, the Great Firewall of China (GFW) is likely to be left
  with only two options: block any transmission it can not understand using any
  method, particularly DPI, or leave shadowsocks alone. So far GFW has chosen
  the latter.
